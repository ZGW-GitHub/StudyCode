...
public class A_ThreadPoolExecutor_ExecutorService {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("线程池初始容量：" + executorService.getCorePoolSize());
        System.out.println("线程池最大容量：" + executorService.getMaximumPoolSize());

        executorService.execute(()-> submitDemo(10, "T1"));
        executorService.execute(()-> submitDemo(1 , "T2"));
        executorService.execute(()-> submitDemo(10,  "T3"));
//        executorService.execute(()-> submitDemo(10,  "T4"));
        ...
        while (true){
            if (activeCount != executorService.getActiveCount() || queueSize != executorService.getQueue().size()) {
                System.out.println("活动线程的大致数量：" + executorService.getActiveCount());
                System.out.println("等待队列中的线程个数：" + executorService.getQueue().size());

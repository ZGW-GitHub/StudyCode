package com.code.spring.cc.ioc.bean.instantiation.basic.bean.factory;
...
/**
 * Spring Bean 的实例化方式 ：通过 Bean 工厂方法
 *
 * @author 愆凡
...
public class BeanInstantiationTest extends MySpringApplicationTest {
	...
	public void byXmlTest() {
		BeanFactory beanFactory = new ClassPathXmlApplicationContext(
				"classpath:/TEST-FILE/cc/ioc/bean/instantiation/bean-instantiation-bean-factory.xml");

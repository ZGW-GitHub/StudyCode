package com.code.spring.cc.ioc.bean.instantiation.other.service.loader;

import com.code.spring.MySpringApplicationTest;
import com.code.spring.cc.ioc.bean.instantiation.other.service.loader.factory.TestUserFactory;
...
public class BeanInstantiationTest extends MySpringApplicationTest {
	...
	public void serviceLoaderFactoryBeanTest() throws Exception {
		BeanFactory beanFactory = new ClassPathXmlApplicationContext(
				"classpath:/TEST-FILE/cc/ioc/bean/instantiation/bean-instantiation-service-loader.xml");

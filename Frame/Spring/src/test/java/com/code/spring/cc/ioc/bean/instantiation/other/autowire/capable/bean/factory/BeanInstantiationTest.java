package com.code.spring.cc.ioc.bean.instantiation.other.autowire.capable.bean.factory;
...
public class BeanInstantiationTest extends MySpringApplicationTest {
	...
	public void test() {
		ApplicationContext applicationContext = new ClassPathXmlApplicationContext(
				"classpath:/TEST-FILE/cc/ioc/bean/instantiation/bean-instantiation-create-bean.xml");

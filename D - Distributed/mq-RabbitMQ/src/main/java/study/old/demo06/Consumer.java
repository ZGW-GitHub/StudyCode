...
public class Consumer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        channel.exchangeDeclare(MyRabbitMQ.EXCHANGE_NAME, BuiltinExchangeType.HEADERS);
        channel.queueBind(MyRabbitMQ.QUEUE_NAME, MyRabbitMQ.EXCHANGE_NAME, "", map);
...
//                channel.basicRecover(false);
        ...
        channel.basicConsume(MyRabbitMQ.QUEUE_NAME, false, consumer);

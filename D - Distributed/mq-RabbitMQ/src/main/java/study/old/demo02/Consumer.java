...
public class Consumer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        channel.queueDeclare(MyRabbitMQ.QUEUE_NAME + 1, true, false, false, null);

        channel.queueBind(MyRabbitMQ.QUEUE_NAME + 1, MyRabbitMQ.EXCHANGE_NAME, "");
        ...
        channel.basicConsume(MyRabbitMQ.QUEUE_NAME + 1, true, consumer);
